...
# dot-few-shot: ex/LlamaTracker/SupernovaPlo/21
# dot-zeroshot: ex/LlamaTracker/DazzlingDengar/21
#_
...
def main():
    ...
    launch.LlamaLaunch(
        **opt_arg,
        groupcode='llama_pretrained_dsg5k_finetune_sgd_fewshot',
        base='ex/LlamaTracker/SupernovaPlo/21',
        approach='LlamaTracker',
        train_data='data/sgd_3s/train',
        eval_data='data/sgd_3s/valid',
