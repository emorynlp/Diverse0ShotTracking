...
base_trained_on_dsg5k = 'ex/LlamaTracker/DazzlingDengar/21'
base_trained_on_dsg5k_filtered = 'ex/LlamaTracker/StalwartLuke/21'
base_trained_on_sgd = 'ex/LlamaTracker/CaptivatingDromundKaas/11'
base_trained_on_sgd_filtered = ...


for domain in ['hotel', 'restaurant', 'taxi', 'attraction', 'train']:
    launch.LlamaLaunch(
        groupcode='llama-finetune-sgd',
        base=base_trained_on_sgd,
